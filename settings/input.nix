...
[
  {
    options.input = make-rendered-section "input" { partial = true; } [
      {
        options.keyboard = make-rendered-section "keyboard" { partial = true; } [
          {
            options.xkb =
              let
                arch-man-xkb =
              ...
              lib.mkOption {
                ...
                type = lib.types.nullOr (
                  lib.types.submodule (
                    make-rendered-options "xkb" { partial = false; } [
                      {
