...
Currently, this is release [`26.04`](https://github.com/niri-wm/niri/releases/tag/26.04) with no additional patches.
...
Currently, this is exactly commit [`49fc611`](https://github.com/niri-wm/niri/tree/49fc6117fd6c043adaa2ead316b82db5ed735d36) which was authored on `2026-06-18 11:11:04`.
...
Whether to force background blur for layer surface, even though the application does not request it.
